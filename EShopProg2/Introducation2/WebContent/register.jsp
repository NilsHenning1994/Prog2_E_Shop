...
<body>
 <div class="wrapper">
  ...
  <p class="title">Registrieren</p>
  	<input type="hidden" name="Modus" id="Modus" value="registrieren" />
    ...
    <br>
    <br>
     <input type="submit" class="state" value="Registrieren" id="registrieren" / >
     Du hast schon einen Account? <a href="login.jsp">Hier</a> kannst Du Dich anmelden.
 </p>
</form>
 </p>
</div>
